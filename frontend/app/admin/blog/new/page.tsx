        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-6 sm:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="Designing for Clarity in Complex Products"
          ...
          <div>
            ...
            <input
              ...
              placeholder="How to reduce cognitive burden in data-dense interfaces without sacrificing power."
              className="w-full rounded-lg border border-zinc-800 bg-zinc-900/60 px-4 py-2.5 text-sm text-white focus:border-emerald-400 focus:outline-none"
            />
            {fieldErrors['excerpt'] && (
              <p className="text-[11px] text-red-400 font-mono mt-1">{fieldErrors['excerpt']}</p>
            )}
          </div>
        </div>
